...
网站的语言，当然你可以在头信息[^font_matter]里指定特定的文章或页面的语言，你可以在[国际化](https://github.com/infinit3/docs/zh/i18n)找到更多信息。
...
这个设置告诉 jekyll-github-metadata 插件应该从哪个项目中获取元数据，其格式为 `项目所有者 ID/项目名称`，例如：infinitenigma/infinit3。
...
该设置在 2.2.0 版中移到了 Articles 和 Home 布局的头信息中，详情请戳 [这里](https://github.com/infinit3/docs/cn/layouts#articles-layout)。
{:.error}
...
你需要在页面的头信息里设置 `sharing` 属性为 `true` 来开启该页的评论，详情请戳 [这里](https://github.com/infinit3/docs/zh/layouts#article-%E5%B8%83%E5%B1%80)。
{:.warning}
...
对于上面所有的评论系统, 你都需要在页面的头信息里设置 `key` 属性来开启该页的评论，详情请戳 [这里](https://github.com/infinit3/docs/zh/layouts#page-%E5%B8%83%E5%B1%80)。
{:.warning}
...
![Leancloud：创建 Class 0](https://raw.githubusercontent.com/infinitenigma/infinit3/master/docs/assets/images/leancloud-create-class-0.jpg){:style="max-height:420px"}{:.border}

在弹出的对话框中填写 Class 的名字，权限选择“无限制”，点击“创建 Class”按钮：

![Leancloud：创建 Class 1](https://raw.githubusercontent.com/infinitenigma/infinit3/master/docs/assets/images/leancloud-create-class-1.jpg){:style="max-height:620px"}{:.border}

当然你可以随时更改 Class 的权限，在应用面板存储子页中选择想要修改的 Class，点击上面菜单的其他 -> 权限设置项，即可进入设置页：

![Leancloud：权限设置](https://raw.githubusercontent.com/infinitenigma/infinit3/master/docs/assets/images/leancloud-authorization.jpg){:style="max-height:300px"}

最后点击应用面板右侧的“设置”，点击“应用 Key” 选项，即可得到对应的 APP ID 和 APP KEY：

![Leancloud：App Info](https://raw.githubusercontent.com/infinitenigma/infinit3/master/docs/assets/images/leancloud-app-info.jpg){:.border}
...
对于上面所有的点击量统计, 你都需要在页面的头信息里设置 `key` 属性来开启该页的统计功能，详情请戳 [这里](https://github.com/infinit3/docs/zh/layouts#page-%E5%B8%83%E5%B1%80)。
{:.warning}
