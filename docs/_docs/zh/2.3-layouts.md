...
| **author**        | `!!map`               | 将在 *authors.yml* 中定义的作者作为某篇文章或页面的作者, 详情请看[作者](https://github.com/infinit3/docs/zh/authors)。 | 2.2.0 |
...
| **type**          | item, brief, grid | TeXt 支持三种文章列表类型，每种类型都对应着一些配置，你可以在 [这里](https://github.com/infinit3/samples.html#articles-layout) 看到相关的示例。 |
