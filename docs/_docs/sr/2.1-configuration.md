---
title: Configuration
permalink: /docs/sr/configuration
...
“NWO” stands for “name with owner.” It is GitHub lingo for the username of the owner of the repository plus a forward slash plus the name of the repository, e.g. infinitenigma/infinit3, where “kitian616” is the owner and “infinit3” is the repository name.
...
This setting has been **MOVED** to the YAML Front Matter of Articles and home layout **Since Version 2.2.0**, You can find more information [HERE](https://github.com/infinit3/docs/en/layouts#articles-layout).
{:.error}
